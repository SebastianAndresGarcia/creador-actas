                ...
                <nav aria-label="Page navigation example">
                    ...
                    <p ><button style={{ border: "none" }} disabled={pagina === 1 || pagina < 1} onClick={previousPage}><li className="page-item"><a className="page-link" >Previous</a></li></button>
                        <input style={{ textAlign:"center", maxWidth : "70px", margin:"4px"}}
                            ...
                            value={input}
                        /> de {maximo} 
                        <button style={{ border: "none", margin:"4px" }} disabled={pagina === Math.ceil(maximo) || pagina > Math.ceil(maximo)} onClick={nextPage}><li className="page-item" ><a class="page-link" >Next</a></li></button>
                        </p>
                    </ul>
                </nav>
            </div>
